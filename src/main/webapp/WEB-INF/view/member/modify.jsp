            ...
            <form action="/member/modify" method="post" onsubmit="return confirm('저장하시겠습니까?')">
                ...
                <div class="mb-3">
                    ...
                    <input oninput="passwordCheck()" id="inputPassword" type="password" class="form-control"
                           name="password"
                           value="">
                    <div class="form-text"> 암호를 입력하지 않으면 기존 암호로 유지됩니다.</div>
                </div>
                <div class="mb-3">
                    <label for="inputPassword" class="form-label">암호확인</label>
                ...
                <div class="mb-3">
                    <label for="inputNicknName" class="form-label">별명</label>
                    <input id="inputNicknName" type="text" class="form-control" name="nickName"
